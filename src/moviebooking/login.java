...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/t.jpg"))); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            String sql = "select * from bookinguser where UserName=? and Userpw1=?";
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        try {
            ...
            if (t1.getText().length() == 0) {
                ...
                String username = t1.getText();
                change a = new change(t1.getText());
                a.setLocationRelativeTo(null);
                a.setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "Incorrect User Name or Password", "Error", JOptionPane.ERROR_MESSAGE);
